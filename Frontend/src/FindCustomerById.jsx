...
export default class FindCustomerById extends Component {
    ...
    render() {
        ...
        <br />
        {
            ...
            <ListGroup>
      <ListGroup.Item variant='dark'>Customer Id: {this.state.res.id}</ListGroup.Item>
      ...
      <ListGroup.Item variant='dark'>Account Number: {this.state.res.accountNumber}</ListGroup.Item>
      <ListGroup.Item variant='dark'>Contact Number: {this.state.res.contactNumber}</ListGroup.Item>
      <ListGroup.Item variant='dark'>City: {this.state.res.city}</ListGroup.Item>
      <ListGroup.Item variant='dark'>Date of Birth: {new Date(this.state.res.dob).toLocaleDateString()}</ListGroup.Item>
      <ListGroup.Item variant='dark'>Email: {this.state.res.email}</ListGroup.Item>
      <ListGroup.Item variant='dark'>Gender: {this.state.res.gender}</ListGroup.Item>
